...
export function ClientProfileSheet({ conversation, agent }: ClientProfileSheetProps) {
    ...
    return (
        <DialogContent
            side="right"
            className="p-0 sm:max-w-md h-screen flex flex-col gap-0 border-l"
            // The DialogContent from ShadCN is not the same as SheetContent.
            // Using a Dialog and styling it to appear as a sheet.
            // This is a workaround because we triggered it from a DialogTrigger in chat-view.
            // A cleaner way would be to refactor chat-view to use SheetTrigger.
            style={{
                position: 'fixed',
                right: 0,
                top: 0,
